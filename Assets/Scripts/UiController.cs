...
public class UiController : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        _ufoHealthText.text = !UfoService.Instance.Ufo.Health.IsDead
            ? "Ufo HP: " + UfoService.Instance.Ufo.Health.CurrentHealth
            : "Alien HP: " + UfoService.Instance.Alien.Health.CurrentHealth;
    }
